...
//=============Ultimo commit funciona hasta userinput to user message ===========
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function sendMessage(message) {
        ...
        console.log("User message:", userMessage); // Log
    ...
    window.sendMessage = sendMessage; // Hacer sendMessage disponible globalmente
    ...
    // Listener for the transcription event
    document.addEventListener('transcriptionReceived', function(event) {
        const transcription = event.detail;
        console.log("Transcription received:", transcription); // Log
        userInput.value = transcription; // Set the transcription in the input field
        sendMessage(transcription); // Send the transcription as a message
    });
});*/
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    /*function generateAndPlayAudio(text) {
        ...
        .then(data => {
            ...
            if (data.audio_file) {
                //console.log(`Playing audio file: /static/audio/${data.audio_file}`); // Log para verificar que se está reproduciendo el audio
                //const audio = new Audio(`/static/audio/${data.audio_file}`);
                const audioPath = `/static/audio/${data.audio_file}`;
